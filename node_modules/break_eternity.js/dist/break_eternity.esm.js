  ...
  _createClass(Decimal, [{
    ...
    value: function increasingInverse(func) {
      ...
      return function (value) {
        ...
        if (value.isNan() || maxX.lt(minX) || value.lt(minY) || value.gt(maxY)) return FC_NN(Number.NaN, Number.NaN, Number.NaN); // Before actually doing the search, let's determine what range we're looking at. First-class function shenanigans incoming.
